  ...
  <div>
    ...
    <b-form @submit="save">
      ...
      <div class="text-right">
        <router-link to="/maintenance/price-categories/all">
...
<script>
    ...
    export default {
      ...
      methods: {
        get(){
          this.is_saving=true;
          this.axios.get('maintenance/price_categories/get',{params:{id:this.form.id}}).then(response => {
        ...
        save(){
          ...
          this.swalConfirmSubmit((data)=>{
              if (data.value) {
                this.is_saving=true;
                this.axios.post('maintenance/price_categories/save',this.form).then(response => {
