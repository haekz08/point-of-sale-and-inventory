  ...
  <div>
    ...
    <b-form @submit="save">
      ...
      <div class="text-right">
        <router-link to="/maintenance/staffs/all">
...
<script>
    ...
    export default {
      ...
      methods: {
        get(){
          this.is_saving=true;
          this.axios.get('maintenance/staffs/get',{params:{id:this.form.id}}).then(response => {
        ...
        save(){
          ...
          this.swalConfirmSubmit((data)=>{
              if (data.value) {
                this.is_saving=true;
                this.axios.post('maintenance/staffs/save',this.form).then(response => {
