    ...
    export default {
        ...
        data(){
            return {
                ...
                table_settings:{
                    api_url:'maintenance/customers/charged_transactions',
                    delete_url:'daily_logs/delete',
                    fields:[
                        {key: 'transaction_date.other_formats.format_1', label:'Transaction Date'},
                        {key: 'charged_number', label:'Reference Numebr'},
                        {key: 'grand_total.other_formats.format_1', label:'Amount Charged'},
                    ]
                }
            }
        },
