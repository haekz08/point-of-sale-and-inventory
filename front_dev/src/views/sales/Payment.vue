    ...
    <b-row class="m-0">
        <b-col cols="5" class="p-2 border border-light bg-dark">
            <div class="list-group" style="background-color:#23242d;border-color:#181924;color:#768192!important">
                ...
                <p class="mb-1 h4">Customer Balance</p>
                </li>
            </div>
        ...
        <b-col class="px-2">
            ...
            <b-row class="m-0 mt-2 border">
                ...
                <b-col class="p-2 bg-white d-flex align-items-center">
                <div class="w-100">
                    <h6 class="mb-1 text-muted">Amount Paid</h6>
                    <input type="number" step="any" class="form-control" v-model="amount_paid"/>
                </div>
                </b-col>
            </b-row>
    ...
    export default {
      ...
      methods: {
        customerSelected(customer){
            ...
            this.balance = customer.total_balance.default;
        ...
        save(){
            ...
            this.ticket.sub_total = this.amount_paid;
            this.ticket.discount = this.discount;
            this.ticket.grand_total = this.amount_paid;
